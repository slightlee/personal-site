...
| 审计日志完整 | PASS | `.harness/observability/checkpoints/cp-personal-site-t10-visual-refresh-20260517123254.md` |
...
- 自动化视觉回归像素对比不在 t10 范围内；当前使用样式契约测试、构建门禁和浏览器溢出检测覆盖主要风险。
